...
1. Post 15: [A Workflow Construct for the Modern Data Scientist](../15-workflow-construct/)
2. Post 16: [Unix Command-Line Workspace Setup for Data Science](../16-unix-workspace-setup/)
3. Post 17: [Multi-Laptop macOS Bootstrap](../17-multi-laptop-bootstrap/)
4. **Post 18: Setting Up Git for Data Science Workflows** (this post)
5. Post 19: [Setting Up Neovim as a Data Science IDE](../19-setupneovim/)
6. Post 20: [Extending the R-Vim Workflow with LaTeX](../20-setupRvimtex/)
7. Post 21: [Modern CLI Replacements for the Shell Layer](../21-modern-cli-replacements/)
8. Post 22: [LLM-Augmented Editing for the Workflow Construct](../22-llm-augmented-editing/)
9. Post 23: [Configuring Yabai as a Tiling Window Manager](../23-setupyabai/)
10. Post 24: [A pocket terminal with ttyd and Tailscale](../24-ttyd_setup/)
11. Post 25: [Install Linux Mint on a MacBook Air](../25-installmintonmacbook/)
