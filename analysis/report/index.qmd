...
More formally, this post documents the version-control concern
...
your name and email, SSH authenticates successfully,
and the test commit appears in the log, the setup is
complete.
